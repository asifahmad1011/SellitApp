...
let SearchService = class SearchService {
    ...
    searchEntries(product) {
        if (product === "") {
            ...
            console.log(params);
            return this.httpClient.get(this.baseUrl + product).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(response => {
