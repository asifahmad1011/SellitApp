    ...
    req.onload=function(){
            ...
            <div class='col-lg-6 rtl-text'>\
                <div class='product-right'>\
                    ...
                    <button type='button' onclick='changeProductState('"+json.products[0].product_id+"',1)' class='btn btn-secondary m-1'>Approve</button>\
                    <button type='button' onclick='changeProductState('"+json.products[0].product_id+"',4)' class='btn btn-primary m-1'>Deny</button>";      
...
///////////////
function changeProductState(product_id,state){
